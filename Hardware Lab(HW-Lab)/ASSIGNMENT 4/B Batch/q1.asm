;Write a program to read a matrix and check whether it is upper triangular matrix or not
section .data
	...
	msgno: db "NO!!!Its not an Upper Triangular Matrix",10
	lenmsgno: equ $-msgno
	msgyes: db "YES!!!Its an Upper Triangular Matrix",10
	lenmsgyes: equ $-msgyes
	sqmat: db "NO!!!Upper Traingular Matrix must be a SQUARE MATRIX",10
	lensqmat: equ $-sqmat
